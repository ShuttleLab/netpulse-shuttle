...
const structuredData = {
  ...
  description: "Free, open-source Android app that monitors internet connectivity and your exit IP, and alerts you the moment the connection drops. Not a VPN.",
