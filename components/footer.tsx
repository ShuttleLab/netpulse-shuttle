      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        <div className="flex flex-col items-center gap-2 text-sm text-muted-foreground">
          <div className="flex items-center gap-3 flex-wrap justify-center">
            ...
            <span className="text-muted-foreground/30">|</span>
            <a href="https://github.com/ShuttleLab/NetPulse" target="_blank" rel="noopener noreferrer" className="hover:text-foreground transition-colors inline-flex items-center gap-1">
          ...
          <p className="flex items-center gap-2 flex-wrap justify-center">
            ...
            <a href="https://note.shuttlelab.org" target="_blank" rel="noopener" className="font-semibold text-foreground hover:text-primary transition-colors">Note Shuttle</a>
            <span className="text-muted-foreground text-xs">{t("common.notePromoDesc")}</span>
            <span className="text-muted-foreground/30">|</span>
            <a href="https://status.shuttlelab.org" target="_blank" rel="noopener" className="font-semibold text-foreground hover:text-primary transition-colors">Status Shuttle</a>
